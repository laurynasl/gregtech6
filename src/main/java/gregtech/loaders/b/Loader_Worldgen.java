...
public class Loader_Worldgen implements Runnable {
	...
	public void run() {
		...
		, new StoneLayerOres(MT.MgCO3                   , U32, 20, 32)
		...
		, new StoneLayerOres(MT.Lignite                 ,  U3, 20, 50, BIOMES_OCEAN_BEACH)
		, new StoneLayerOres(MT.Coal                    ,  U6, 20, 50, BIOMES_OCEAN_BEACH)
		...
		, new StoneLayerOres(MT.OREMATS.Cobaltite       , U32, 24, 56)
		...
		, new StoneLayerOres(MT.OREMATS.Perlite         , U4 ,  0, 16)
		, new StoneLayerOres(MT.OREMATS.Malachite       , U16,  0, 16)
		);
		StoneLayer.bothsides(MT.STONES.Andesite, MT.STONES.Basalt
		...
		StoneLayer.bothsides(MT.STONES.GraniteRed, MT.STONES.Kimberlite
		, new StoneLayerOres(MT.OREMATS.Vermiculite     , U8 , 48, 80)
		, new StoneLayerOres(MT.Asbestos                , U64, 16, 48)
		);
		StoneLayer.bothsides(MT.STONES.GraniteBlack, MT.STONES.Kimberlite
		, new StoneLayerOres(MT.OREMATS.Mica            , U8 , 16, 48)
		, new StoneLayerOres(MT.Biotite                 , U16, 16, 48)
		);
		StoneLayer.bothsides(MT.STONES.GraniteBlack, MT.STONES.Diorite
		...
		new WorldgenOresVanilla("twilight.ore.duranium_hexaastatide", T, tBlock, 10,  1, 12,   4,  8, 24, null                  , 0, BIOMES_FROZEN      , F, GEN_TWILIGHT);
		new WorldgenOresVanilla("twilight.ore.duranium_hexaiodide"  , T, tBlock, 11,  1,  6,   1,  8, 24, null                  , 0, null               , F, GEN_TWILIGHT);
		...
		new WorldgenOresVanilla("twilight.ore.malachite"            , T, tBlock, 14,  1, 16,   1,  8, 16, null                  , 0, BIOMES_SWAMP       , F, GEN_TWILIGHT);
		...
		new WorldgenOresBedrock("ore.bedrock.coal"         , T, T,   1000, MT.Coal                , BlocksGT.FlowersA, 7, GEN_FLOOR); // TODO Coal/Carbon Flower
		...
		new WorldgenOresLarge("ore.large.coal"        , T, T, 50,  80,  60, 6, 32, MT.Coal                         , MT.Coal                        , MT.Coal                        , MT.Lignite            , ORE_OVERWORLD, ORE_A97, ORE_ENVM, ORE_CW2_AquaCavern, ORE_CW2_Caveland, ORE_CW2_Cavenia, ORE_CW2_Cavern, ORE_CW2_Caveworld, ORE_EREBUS, ORE_ATUM);
		...
		new WorldgenOresLarge("ore.large.asbestos"    , T, T, 10,  40,  30, 3, 16, MT.KIO3                         , MT.Talc                        , MT.Gypsum                      , MT.Asbestos           , ORE_OVERWORLD, ORE_A97, ORE_ENVM, ORE_CW2_AquaCavern, ORE_CW2_Caveland, ORE_CW2_Cavenia, ORE_CW2_Cavern, ORE_CW2_Caveworld, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS);
		...
		new WorldgenOresLarge("ore.large.peridot"     , T, T, 10,  40,  60, 3, 16, MT.OREMATS.Coltan               , MT.MgCO3                       , MT.Peridot                     , MT.OREMATS.Glauconite , ORE_OVERWORLD, ORE_A97, ORE_ENVM, ORE_CW2_AquaCavern, ORE_CW2_Caveland, ORE_CW2_Cavenia, ORE_CW2_Cavern, ORE_CW2_Caveworld, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS, ORE_PLANETS, ORE_MOON);
		...
		new WorldgenOresLarge("ore.large.beryllium"   , T, T,  5,  30,  15, 3, 16, MT.Aquamarine                   , MT.Maxixe                      , MT.Emerald                     , MT.Azurite            , ORE_OVERWORLD, ORE_A97, ORE_ENVM, ORE_CW2_AquaCavern, ORE_CW2_Caveland, ORE_CW2_Cavenia, ORE_CW2_Cavern, ORE_CW2_Caveworld, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS);
		...
		new WorldgenOresLarge("ore.large.nickel"      , T, T, 10,  40,  40, 3, 16, MT.OREMATS.Garnierite           , MT.Ni                          , MT.OREMATS.Garnierite          , MT.OREMATS.Pentlandite, ORE_OVERWORLD, ORE_A97, ORE_ENVM, ORE_CW2_AquaCavern, ORE_CW2_Caveland, ORE_CW2_Cavenia, ORE_CW2_Cavern, ORE_CW2_Caveworld, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS);
		...
		new WorldgenOresLarge("ore.large.iron"        , T, T, 10,  40, 120, 4, 24, MT.OREMATS.BrownLimonite        , MT.OREMATS.YellowLimonite      , MT.Fe2O3                       , MT.Au                 , ORE_OVERWORLD, ORE_A97, ORE_ENVM, ORE_CW2_AquaCavern, ORE_CW2_Caveland, ORE_CW2_Cavenia, ORE_CW2_Cavern, ORE_CW2_Caveworld, ORE_EREBUS, ORE_ATUM, ORE_BETWEENLANDS, ORE_MARS);
