...
public class MT {
	...
	*/
	...
	Eudialyte               = elec          ( 8421, "Eudialyte"             , SET_LAPIS             , 155,  96, 114, 255, G_GEM_ORES, CRYSTAL, MORTAR, BRITTLE)                                                                                                     .uumMcfg(64, Zircon         ,18*U, OREMATS.Pitchblende             , 1*U, Na               ,13*U, Ca               , 6*U, NaCl, U*4, SiO2, 75*U, O, 14*U)                  .aspects(TC.VITREUS, 1), // Na15Ca6(Fe,Mn)3Zr3SiO(O,OH,H2O)3 (Si3O9)2(Si9O27)2(OH,Cl)2
