...
public class MT {
	...
	PotassiumFeldspar       = oredustelec   ( 9140, "Potassium Feldspar"    , SET_FINE              , 120,  40,  40, 255)                                                                                                                                           .uumMcfg( 0, K              , 2*U, OREMATS.Bauxite  , 5*U, SiO2             ,18*U, O                , 1*U)                                                  ,
	Biotite                 = oredustelec   ( 9141, "Biotite"               , SET_METALLIC          ,  20,  30,  20, 255)                                                                                                                                           .setMcfg( 0, K              , 2*U, Mg               , 6*U, OREMATS.Bauxite  ,15*U, F                , 4*U, SiO2             ,18*U)                          .addSourceOf(Ar,K,F,Al), // releases Argon when heated.
	...
	Ceramic                 = dustelec      ( 8225, "Ceramic"               , SET_ROUGH             , 220, 130,  70, 255, MORTAR, PLATES, BRITTLE)                                                                                                                  .uumMcfg(18, OREMATS.Bauxite, 5*U, SiO2             ,12*U)                                                                                                  .heat(2000).setCompressing(null, 0).setBending(null, 0).setForging(null, 0).setSmashing(null, 0),
	...
	Emerald                 = emerald       ( 8301, "Emerald"                                       ,  80, 255,  80, DYE_INDEX_Green      )                                                                                                                         .uumMcfg( 0, OREMATS.Bauxite, 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.LUCRUM     , 2),
	Aquamarine              = emerald       ( 8323, "Aquamarine"                                    , 200, 220, 255, DYE_INDEX_Cyan       )                                                                                                                         .uumMcfg( 0, OREMATS.Bauxite, 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.AQUA       , 2),
	Morganite               = emerald       ( 8324, "Morganite"                                     , 255, 200, 200, DYE_INDEX_Pink       )                                                                                                                         .uumMcfg( 0, OREMATS.Bauxite, 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.TEMPESTAS  , 2),
	Heliodor                = emerald       ( 8384, "Heliodor"                                      , 255, 255, 150, DYE_INDEX_Yellow     )                                                                                                                         .uumMcfg( 0, OREMATS.Bauxite, 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.LUX        , 2),
	Goshenite               = emerald       ( 8385, "Goshenite"                                     , 240, 240, 240, DYE_INDEX_White      )                                                                                                                         .uumMcfg( 0, OREMATS.Bauxite, 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.VACUOS     , 2),
	Bixbite                 = emerald       ( 8386, "Bixbite"                                       , 255,  80,  80, DYE_INDEX_Red        , "ScarletEmerald")                                                                                                       .uumMcfg( 0, OREMATS.Bauxite, 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.SANO       , 2),
	Maxixe                  = emerald       ( 8387, "Maxixe"                                        ,  80,  80, 255, DYE_INDEX_Blue       )                                                                                                                         .uumMcfg( 0, OREMATS.Bauxite, 5*U, Be               , 3*U, SiO2             ,18*U, O                , 3*U)                                                  .aspects(TC.RADIO      , 2),
	
	
	Sapphire                = sapphire      ( 8304, "Sapphire"                                      , 120, 120, 160, DYE_INDEX_Blue       , "Saphire")                                                                                                              .uumMcfg( 6, OREMATS.Bauxite, 5*U)                                                                                                                          .aspects(TC.LUCRUM     , 1),
	Ruby                    = sapphire      ( 8302, "Ruby"                                          , 255, 100, 100, DYE_INDEX_Red        )                                                                                                                         .uumMcfg( 6, OREMATS.Bauxite, 5*U, Cr               , 1*U)                                                                                                  .aspects(TC.MACHINA    , 1),
	BlueSapphire            = sapphire      ( 8328, "Blue Sapphire"                                 , 100, 100, 200, DYE_INDEX_Blue       )                                                                                                                         .uumMcfg( 6, OREMATS.Bauxite, 5*U, Fe               , 1*U)                                                                                                  .aspects(TC.METALLUM   , 1),
	GreenSapphire           = sapphire      ( 8305, "Green Sapphire"                                , 100, 200, 130, DYE_INDEX_Green      )                                                                                                                         .uumMcfg( 6, OREMATS.Bauxite, 5*U, Mg               , 1*U)                                                                                                  .aspects(TC.SANO       , 1),
	PurpleSapphire          = sapphire      ( 8383, "Purple Sapphire"                               , 220,  50, 255, DYE_INDEX_Purple     )                                                                                                                         .uumMcfg( 6, OREMATS.Bauxite, 5*U, V                , 1*U)                                                                                                  .aspects(TC.ELECTRUM   , 1),
	YellowSapphire          = sapphire      ( 8315, "Yellow Sapphire"                               , 220, 220,  50, DYE_INDEX_Yellow     )                                                                                                                         .uumMcfg( 6, OREMATS.Bauxite, 5*U, TiO2             , 1*U)                                                                                                  .aspects(TC.TUTAMEN    , 1),
	OrangeSapphire          = sapphire      ( 8314, "Orange Sapphire"                               , 220, 150,  50, DYE_INDEX_Orange     )                                                                                                                         .uumMcfg( 6, OREMATS.Bauxite, 5*U, Cu               , 1*U)                                                                                                  .aspects(TC.PERMUTATIO , 1),
	
	
	Spinel                  = valgemelec    ( 8326, "Spinel"                , SET_GEM_VERTICAL      ,   0, 100,   0, 127, RANDOM_SMALL_GEM_ORE)                                          .lens(DYE_INDEX_Green)                                                     .uumMcfg( 0, OREMATS.Bauxite, 5*U, Mg               , 1*U, O                , 1*U)                                                                          .aspects(TC.VITREUS, 2, TC.LUCRUM                   , 3).qual(3,  7.0,   384,  2),
	...
	Almandine               = garnet        ( 9101, "Almandine"                                     , 255,   0,   0, DYE_INDEX_Red        , "GarnetRed")                                                                                                            .uumMcfg( 0, OREMATS.Bauxite, 5*U, Fe               , 3*U, SiO2             , 9*U, O                , 3*U)                                                  .aspects(TC.METALLUM   , 1),
	Grossular               = garnet        ( 9119, "Grossular"                                     , 200, 100,   0, DYE_INDEX_Orange     , "GarnetOrange")                                                                                                         .uumMcfg( 0, OREMATS.Bauxite, 5*U, Ca               , 3*U, SiO2             , 9*U, O                , 3*U)                                                  .aspects(TC.VOLATUS    , 1),
	Pyrope                  = garnet        ( 9127, "Pyrope"                                        , 120,  50, 100, DYE_INDEX_Purple     , "GarnetPurple")                                                                                                         .uumMcfg( 0, OREMATS.Bauxite, 5*U, Mg               , 3*U, SiO2             , 9*U, O                , 3*U)                                                  .aspects(TC.SANO       , 1),
	Spessartine             = garnet        ( 9129, "Spessartine"                                   , 255, 100, 100, DYE_INDEX_Red        , "Garnet")                                                                                                               .uumMcfg( 0, OREMATS.Bauxite, 5*U, Mn               , 3*U, SiO2             , 9*U, O                , 3*U)                                                  .aspects(TC.METALLUM   , 1),
	...
	Topaz                   = valgemelec    ( 8306, "Topaz"                 , SET_GEM_HORIZONTAL    , 255, 128,   0, 127, RANDOM_SMALL_GEM_ORE                                ).lens(DYE_INDEX_Orange     )                                                         .uumMcfg( 0, OREMATS.Bauxite, 5*U, SiO2             , 3*U, F                , 2*U, H2O              , 3*U)                                                  .aspects(TC.VITREUS, 4, TC.LUCRUM, 4, TC.POTENTIA   , 2).qual(3,  7.0,   256,  3),
	BlueTopaz               = valgemelec    ( 8307, "Blue Topaz"            , SET_GEM_HORIZONTAL    , 123, 150, 220, 127, RANDOM_SMALL_GEM_ORE                                ).lens(DYE_INDEX_Blue       )                                                         .uumMcfg( 0, OREMATS.Bauxite, 5*U, SiO2             , 3*U, F                , 2*U, H2O              , 3*U)                                                  .aspects(TC.VITREUS, 4, TC.LUCRUM, 4, TC.POTENTIA   , 2).qual(3,  7.0,   256,  3).setGenerifying(Topaz),
	Tanzanite               = valgemelec    ( 8308, "Tanzanite"             , SET_GEM_HORIZONTAL    ,  64,   0, 200, 127, RANDOM_SMALL_GEM_ORE                                ).lens(DYE_INDEX_Purple     )                                                         .uumMcfg( 0, OREMATS.Bauxite,15*U, SiO2             ,18*U, Ca               , 4*U, H2O              , 3*U, O                , 4*U)                          .aspects(TC.VITREUS, 3, TC.LUCRUM                   , 5).qual(3,  7.0,   256,  2),
	Zanite                  = valgemelec    ( 8292, "Zanite"                , SET_REDSTONE          , 146,  73, 255, 127, CRYSTALLISABLE                                      ).lens(DYE_INDEX_Purple     )                                                         .uumMcfg( 0, OREMATS.Bauxite,15*U, SiO2             ,18*U, Ca               , 4*U, H2O              , 3*U, O                , 4*U)                          .aspects(TC.VITREUS, 3, TC.PERFODIO                 , 4).qual(3, 16.0,   512,  2).setGenerifying(Tanzanite),
	Amazonite               = valgemelec    ( 8417, "Amazonite"             , SET_LAPIS             ,  71, 241, 170, 255, RANDOM_SMALL_GEM_ORE, MD.VOLTZ                      ).lens(DYE_INDEX_Green      )                                                         .uumMcfg( 0, OREMATS.Bauxite, 5*U, SiO2             ,18*U, K                , 2*U, O                , 1*U)                                                  .aspects(TC.VITREUS, 3, TC.LUCRUM                   , 5).qual(3,  7.0,   256,  2),
	Alexandrite             = valgemelec    ( 8388, "Alexandrite"           , SET_OPAL              , 200, 255, 170, 127  /* no small ores for this */                        ).lens(DYE_INDEX_Lime       )                                                         .uumMcfg( 0, OREMATS.Bauxite, 1*U, Be               , 1*U, O                , 1*U)                                                                          .aspects(TC.VITREUS, 4, TC.LUCRUM, 2, TC.AURAM      , 1).qual(3,  7.0,   512,  3),
	...
	*/
	...
	Lazurite                = elec          ( 8330, "Lazurite"              , SET_LAPIS             , 100, 120, 255, 255, G_GEM_ORES, DENSEPLATES, CRYSTAL, CRYSTALLISABLE, MORTAR, BRITTLE)                                                                        .uumMcfg( 0, OREMATS.Bauxite, 6*U, SiO2             , 6*U, Ca               , 8*U, Na               , 8*U)                                                  .aspects(TC.SENSUS, 1),
	Sodalite                = elec          ( 8331, "Sodalite"              , SET_LAPIS             ,  20,  20, 255, 255, G_GEM_ORES, DENSEPLATES, CRYSTAL, CRYSTALLISABLE, MORTAR, BRITTLE)                                                                        .uumMcfg( 0, OREMATS.Bauxite, 3*U, SiO2             , 3*U, Na               , 4*U, Cl               , 1*U)                                                  .aspects(TC.SENSUS, 1),
	...
	CoalCoke                = coal          ( 8349, "Coal Coke"             , SET_LIGNITE           , 140, 140, 170, 255, TICKS_PER_SMELT*16, "Coke").setBurning(DarkAsh, U4)                                                                                       .uumMcfg( 0, C              , 1*U)                                                                                                                          .setSmelting(C, U ).heat(1700, C.mBoilingPoint).setDensity(0.929).aspects(TC.POTENTIA, 3, TC.IGNIS, 1).steal(Coal),
	...
	Lignite                 = coal          ( 8337, "Lignite"               , SET_LIGNITE           , 100,  70,  70, 255, TICKS_PER_SMELT* 4).setBurning(DarkAsh, U4)                                                                                               .setMcfg( 4, C              , 2*U, H2O              , 4*U, DarkAsh          , 1*U)                                                                          .setDensity(0.865).setLocal("Lignite Coal"),
	LigniteCoke             = coal          ( 8365, "Lignite Coke"          , SET_LIGNITE           , 140, 100, 100, 255, TICKS_PER_SMELT* 8).setBurning(DarkAsh, U4)                                                                                               .setMcfg( 4, C              , 2*U, DarkAsh          , 1*U)                                                                                                  .setDensity(0.865),
	PetCoke                 = coal          ( 8390, "Petroleum Coke"        , SET_LIGNITE           , 150, 150, 180, 255, TICKS_PER_SMELT*32, "PetCoke").setBurning(DarkAsh, U4)                                                                                    .uumMcfg( 1, C              , 2*U, S                , 1*U)                                                                                                  .setDensity(0.929).aspects(TC.POTENTIA, 3, TC.IGNIS, 1).steal(Coal),
...
//  InfusedGold             = slloymachore  ( 8712, "Infused Gold"                                  , 255, 200,  60     , SOFT).qual(2, 12.0, 64, 3)                                                                                                                                                                                                                                                                            ,
	...
	Draconium               = metalmachore  ( 8791, "Draconium"                                     , 150,  50, 250     , UNBURNABLE, WITHER_PROOF, ENDER_DRAGON_PROOF, VALUABLE, MOLTEN).qual(3, 16.0,  5000, 4)                                                                                                                                                                                                               .aspects(TC.METALLUM, 2, TC.ALIENIS, 1).heat(4500)                         .uumAloy( 0, Th             , 1*U, Ad               , 1*U),
	...
	public static class TECH {
		...
		static void init() {
			...
			OREMATS.Chalcopyrite            .ores(Pyrite                    , Cd                    , Au                    , OREMATS.Sperrylite    , OREMATS.Stannite      , In                    );
			OREMATS.Sperrylite              .ores(Sb                        , Cu                        , Fe2O3                 , Rh                    , OREMATS.Cooperite     );
			OREMATS.Pentlandite             .ores(Fe2O3                     , S                         , OREMATS.Sperrylite    , Gypsum                );
			...
			OREMATS.Bauxite                 .ores(Kaolinite                 , OREMATS.Ilmenite          , Fe2O3);
			AlO3H3                          .ores(OREMATS.Bauxite           , OREMATS.Ilmenite          , Fe2O3);
			...
			OREMATS.Glauconite              .ores(Na                        , OREMATS.Bauxite           , Fe2O3                 );
			...
			Be                              .ores(OREMATS.Bauxite           , Emerald                   , Aquamarine            , Morganite             , Goshenite             , Bixbite               , Heliodor              , Maxixe    ).addSourceOf(Emerald, Be, Al);
			Emerald                         .ores(OREMATS.Bauxite           , Be                        , Aquamarine            , Morganite             , Goshenite             , Bixbite               , Heliodor              , Maxixe    ).addSourceOf(Emerald, Be, Al);
			Aquamarine                      .ores(OREMATS.Bauxite           , Be                        , Emerald               , Morganite             , Goshenite             , Bixbite               , Heliodor              , Maxixe    ).addSourceOf(Emerald, Be, Al);
			Morganite                       .ores(OREMATS.Bauxite           , Be                        , Emerald               , Aquamarine            , Goshenite             , Bixbite               , Heliodor              , Maxixe    ).addSourceOf(Emerald, Be, Al);
			Goshenite                       .ores(OREMATS.Bauxite           , Be                        , Emerald               , Aquamarine            , Morganite             , Bixbite               , Heliodor              , Maxixe    ).addSourceOf(Emerald, Be, Al);
			Bixbite                         .ores(OREMATS.Bauxite           , Be                        , Emerald               , Aquamarine            , Morganite             , Goshenite             , Heliodor              , Maxixe    ).addSourceOf(Emerald, Be, Al);
			Heliodor                        .ores(OREMATS.Bauxite           , Be                        , Emerald               , Aquamarine            , Morganite             , Goshenite             , Bixbite               , Maxixe    ).addSourceOf(Emerald, Be, Al);
			Maxixe                          .ores(OREMATS.Bauxite           , Be                        , Emerald               , Aquamarine            , Morganite             , Goshenite             , Bixbite               , Heliodor  ).addSourceOf(Emerald, Be, Al);
			
			Sapphire                        .ores(OREMATS.Bauxite           , Ruby                      , GreenSapphire         , BlueSapphire          ).addSourceOf(Sapphire, Al);
			Ruby                            .ores(OREMATS.Bauxite           , OrangeSapphire            , GreenSapphire         , BlueSapphire          ).addSourceOf(Sapphire, Al);
			GreenSapphire                   .ores(OREMATS.Bauxite           , Ruby                      , YellowSapphire        , BlueSapphire          ).addSourceOf(Sapphire, Al);
			BlueSapphire                    .ores(OREMATS.Bauxite           , Ruby                      , GreenSapphire         , PurpleSapphire        ).addSourceOf(Sapphire, Al);
			YellowSapphire                  .ores(OREMATS.Bauxite           , Ruby                      , GreenSapphire         , BlueSapphire          ).addSourceOf(Sapphire, Al);
			OrangeSapphire                  .ores(OREMATS.Bauxite           , Ruby                      , GreenSapphire         , BlueSapphire          ).addSourceOf(Sapphire, Al);
			PurpleSapphire                  .ores(OREMATS.Bauxite           , Ruby                      , GreenSapphire         , BlueSapphire          ).addSourceOf(Sapphire, Al);
			...
			Spinel                          .ores(OREMATS.Bauxite           , BalasRuby                 );
			...
			Monazite                        .ores(Nd                        , RareEarth             );
			Forcicium                       .ores(Nd                        , RareEarth             );
			Forcillium                      .ores(Nd                        , RareEarth             );
			...
			OREMATS.YellowLimonite          .ores(Ni                        , OREMATS.BrownLimonite     );
			...
			OREMATS.Wolframite              .ores(Fe2O3                     , OREMATS.Stannite      , MgCO3);
			OREMATS.Ferberite               .ores(Fe2O3                     );
			OREMATS.Russellite              .ores(Bi                        );
			OREMATS.Stolzite                .ores(Pb                        );
			OREMATS.Pinalite                .ores(Pb                        );
			...
			OREMATS.Spodumene               .ores(OREMATS.Bauxite           , LiCl                      );
			...
			Brass                           .ores(Cu                        , Zn                        , As                    );
			Coal                            .ores(Lignite                   , Anthracite                , Oilshale              , S                     );
			Lignite                         .ores(Coal                      , Ge                        , Oilshale              , S                     );
			Oilshale                        .ores(Prismane                  , Lonsdaleite               , Coal                  );
			Anthracite                      .ores(Prismane                  , Lonsdaleite               , OREMATS.DuraniumHexaastatide);
...
//          Al                      .addAlloyingRecipe(new OreDictConfigurationComponent( 1, OM.stack(OREMATS.Bauxite               , 2*U), OM.stack(K                  , 1*U)));
	...
	public static class OREMATS {
		...
		Zeolite                 = oredustelec( 9165, "Zeolite"                   , SET_DULL      , 240, 230, 230, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Na,Al    ).setMcfg( 0, OREMATS.Bauxite, 5*U, Na               , 2*U, SiO2             ,12*U, H2O              , 6*U, O                , 1*U)                        , // Na2Al2Si4O12 2H2O
		Pollucite               = oredustelec( 9147, "Pollucite"                 , SET_DULL      , 240, 210, 210, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Cs,Al    ).setMcfg( 0, OREMATS.Bauxite, 5*U, Cs               , 2*U, SiO2             ,12*U, H2O              , 6*U, O                , 1*U)                        , // Cs2Al2Si4O12 2H2O (also a source of Rb)
		...
		Spodumene               = oredustelec( 9146, "Spodumene"                 , SET_DULL      , 190, 170, 170, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Al,Li    ).setMcfg( 0, OREMATS.Bauxite, 5*U, Li               , 2*U, SiO2             ,12*U, O                , 1*U)                                                , // LiAl(SiO3)2
		Lepidolite              = oredustelec( 9149, "Lepidolite"                , SET_FINE      , 240,  50, 140, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Al,K,Li,F).setMcfg( 0, OREMATS.Bauxite,10*U, K                , 1*U, Li               , 3*U, F                , 2*U, O                , 6*U)                        , // K(Li,Al,Rb)3(Al,Si)4O10(F,OH)2
		Glauconite              = oredustelec( 9150, "Glauconite"                , SET_DULL      , 130, 180,  60, 255, MORTAR, BLACKLISTED_SMELTER, "GlauconiteSand"                                  )                         .addSourceOf(Al,K     ).setMcfg( 0, OREMATS.Bauxite,10*U, K                , 1*U, Mg               , 2*U, H2O              , 3*U, O                , 7*U)                        , GlauconiteSand = Glauconite, // (K,Na)(Fe3+,Al,Mg)2(Si,Al)4O10(OH)2
//      GlauconiteSand          = oredustelec( 9151, "Glauconite Sand"           , SET_DULL      , 130, 180,  60, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Al,K     ).setMcfg( 0, Al2O3          ,10*U, K                , 1*U, Mg               , 2*U, H2O              , 3*U, O                , 7*U)                        , // (K,Na)(Fe3+,Al,Mg)2(Si,Al)4O10(OH)2
		Vermiculite             = oredustelec( 9152, "Vermiculite"               , SET_METALLIC  , 200, 180,  15, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Al       ).setMcfg( 0, OREMATS.Bauxite,10*U, Fe               , 3*U, SiO2             ,12*U, H2O              ,12*U, H                , 2*U)                        , // (Mg+2, Fe+2, Fe+3)3 [(AlSi)4O10] (OH)2 4H2O)
		Mica                    = oredustelec( 9158, "Mica"                      , SET_FINE      , 195, 195, 205, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Al,K,F   ).setMcfg( 0, OREMATS.Bauxite,15*U, K                , 2*U, SiO2             ,18*U, F                , 4*U)                                                , // KAl2(AlSi3O10)(F,OH)2
		Kyanite                 = oredustelec( 9166, "Kyanite"                   , SET_FLINT     , 110, 110, 250, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Al       ).setMcfg( 0, OREMATS.Bauxite, 5*U, SiO2             , 3*U)                                                                                                , // Al2SiO5
		Alunite                 = oredustelec( 9162, "Alunite"                   , SET_METALLIC  , 225, 180,  65, 255, MORTAR, BLACKLISTED_SMELTER                                                    )                         .addSourceOf(Al,K     ).setMcfg( 0, OREMATS.Bauxite,15*U, KOH              , 6*U, SO3              ,16*U, H2O              ,15*U, O                , 9*U)                        , // KAl3(SO4)2(OH)6
