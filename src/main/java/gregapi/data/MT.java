...
public class MT {
	...
	Alexandrite             = valgemelec    ( 8388, "Alexandrite"           , SET_OPAL              , 200, 255, 170, 127, RANDOM_SMALL_GEM_ORE                                ).lens(DYE_INDEX_Yellow     )                                                         .uumMcfg( 0, OREMATS.Bauxite, 1*U, Be               , 1*U, O                , 1*U)                                                                          .aspects(TC.VITREUS, 4, TC.LUCRUM, 2, TC.AURAM      , 1).qual(3,  7.0,   256,  2),
